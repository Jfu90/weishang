...
<template>
  <div class="container-fluid">
    <div class="row" style="height: 630px">
      <div class="col-3 text-dark-700 bg-light h-100 overflow-auto">
      ...
      <div v-if="resDatas.length" class="col-9 py-3 d-flex flex-column h-100">
        ...
        <div class="row px-2">
          ...
          <div class="col-4">
            <div class="tableTitleFixed text-dark-700 bg-light text-center" style="height: 563px">
              <table width="100%">
                <thead class="bg-info">
                  <tr style="height: 30px; font-size: 0.8rem">
                    <td class="ps-2 text-start">Dst Host</td>
                    <td>Flows</td>
                    <td>Octets</td>
                    <td class="pe-2">Packets</td>
                  </tr>
                </thead>
                <tbody>
                  <tr v-for="(i, key) of resRows" :key="key">
                    <td class="ps-2 text-start">
                      <p class="m-0 py-2 border-bottom border-dark-300">{{ `192.168.${i}.136` }}</p>
                    </td>
                    <td><p class="m-0 py-2 border-bottom border-dark-300">156</p></td>
                    <td><p class="m-0 py-2 border-bottom border-dark-300">42.34 KB</p></td>
                    <td class="pe-2"><p class="m-0 py-2 border-bottom border-dark-300">156</p></td>
                  </tr>
                </tbody>
              </table>
            </div>
